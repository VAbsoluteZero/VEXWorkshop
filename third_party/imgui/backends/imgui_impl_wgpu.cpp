    0x0000001c, 0x0004003b, 0x00000014, 0x00000023, 0x00000001, 0x0004002b, 0x00000006, 0x00000025,
    0x00000000, 0x0004002b, 0x00000006, 0x00000026, 0x3f800000, 0x00050036, 0x00000002, 0x00000004,
    ...
    0x00000013, 0x0003003e, 0x00000018, 0x00000016, 0x00050041, 0x00000020, 0x00000021, 0x0000001f,
    0x0000000d, 0x0004003d, 0x0000001c, 0x00000022, 0x00000021, 0x0004003d, 0x00000008, 0x00000024,
    0x00000023, 0x00050051, 0x00000006, 0x00000027, 0x00000024, 0x00000000, 0x00050051, 0x00000006,
    0x00000028, 0x00000024, 0x00000001, 0x00070050, 0x00000007, 0x00000029, 0x00000027, 0x00000028,
    0x00000025, 0x00000026, 0x00050091, 0x00000007, 0x0000002a, 0x00000022, 0x00000029, 0x00050041,
    0x00000011, 0x0000002b, 0x0000001b, 0x0000000d, 0x0003003e, 0x0000002b, 0x0000002a, 0x000100fd,
    0x00010038};
...
*/
static const char* wgsl_vert_code = R"(
struct S {
  Color : vec4<f32>,
  UV : vec2<f32>,
}
...
var<private> aColor : vec4<f32>;

var<private> aUV : vec2<f32>;

@group(0) @binding(0) var<uniform> x_31 : transform;

var<private> aPos : vec2<f32>;

var<private> gl_Position : vec4<f32>;

fn main_1() {
  let x_16 : vec4<f32> = aColor;
  Out.Color = x_16;
  let x_22 : vec2<f32> = aUV;
  Out.UV = x_22;
  let x_34 : mat4x4<f32> = x_31.mvp;
  let x_36 : vec2<f32> = aPos;
  gl_Position = (x_34 * vec4<f32>(x_36.x, x_36.y, 0.0f, 1.0f));
  return;
}
...
@vertex
fn main(@location(2) aColor_param : vec4<f32>, @location(1) aUV_param : vec2<f32>, @location(0) aPos_param : vec2<f32>) -> main_out {
  aColor = aColor_param;
  aUV = aUV_param;
  aPos = aPos_param;
  main_1();
  return main_out(Out.Color, Out.UV, gl_Position);
}
)";
static const char* wgsl_frag_code = R"(
struct S {
  Color : vec4<f32>,
  UV : vec2<f32>,
}
...
fn main_1() {
  let x_18 : vec4<f32> = In.Color;
  let x_32 : vec2<f32> = In.UV;
  let x_33 : vec4<f32> = textureSample(t, s, x_32);
  fColor = (x_18 * x_33);
  return;
}
...
@fragment
fn main(@location(0) In_param : vec4<f32>, @location(1) In_param_1 : vec2<f32>) -> main_out {
  In.Color = In_param;
  In.UV = In_param_1;
  main_1();
  return main_out(fColor);
}
)";

static uint32_t __glsl_shader_frag_spv[] = {0x07230203, 0x00010000, 0x00080007, 0x00000023,
    0x00000000, 0x00020011, 0x00000001, 0x0006000b, 0x00000001, 0x4c534c47, 0x6474732e, 0x3035342e,
    0x00000000, 0x0003000e, 0x00000000, 0x00000001, 0x0007000f, 0x00000004, 0x00000004, 0x6e69616d,
    0x00000000, 0x00000009, 0x0000000d, 0x00030010, 0x00000004, 0x00000007, 0x00030003, 0x00000002,
    0x000001c2, 0x00040005, 0x00000004, 0x6e69616d, 0x00000000, 0x00040005, 0x00000009, 0x6c6f4366,
    0x0000726f, 0x00030005, 0x0000000b, 0x00000000, 0x00050006, 0x0000000b, 0x00000000, 0x6f6c6f43,
    0x00000072, 0x00040006, 0x0000000b, 0x00000001, 0x00005655, 0x00030005, 0x0000000d, 0x00006e49,
    0x00030005, 0x00000015, 0x00000074, 0x00030005, 0x00000019, 0x00000073, 0x00040047, 0x00000009,
    0x0000001e, 0x00000000, 0x00040047, 0x0000000d, 0x0000001e, 0x00000000, 0x00040047, 0x00000015,
    0x00000022, 0x00000001, 0x00040047, 0x00000015, 0x00000021, 0x00000000, 0x00040047, 0x00000019,
    0x00000022, 0x00000000, 0x00040047, 0x00000019, 0x00000021, 0x00000001, 0x00020013, 0x00000002,
...
{
    if (res)
        WGPU_REL(wgpuBindGroupLayout, res);
    res = NULL;
}
static void SafeRelease(WGPUBindGroup& res)
{
    if (res)
        WGPU_REL(wgpuBindGroup, res);
    res = NULL;
}
static void SafeRelease(WGPUBuffer& res)
{
    if (res)
        WGPU_REL(wgpuBuffer, res);
    res = NULL;
}
static void SafeRelease(WGPURenderPipeline& res)
{
    if (res)
        WGPU_REL(wgpuRenderPipeline, res);
    res = NULL;
}
static void SafeRelease(WGPUSampler& res)
{
    if (res)
        WGPU_REL(wgpuSampler, res);
    res = NULL;
}
static void SafeRelease(WGPUShaderModule& res)
{
    if (res)
        WGPU_REL(wgpuShaderModule, res);
    res = NULL;
}
static void SafeRelease(WGPUTextureView& res)
{
    if (res)
        WGPU_REL(wgpuTextureView, res);
    res = NULL;
}
static void SafeRelease(WGPUTexture& res)
{
    if (res)
        WGPU_REL(wgpuTexture, res);
    res = NULL;
}
...
static void ImGui_ImplWGPU_SetupRenderState(
    ImDrawData* draw_data, WGPURenderPassEncoder ctx, FrameResources* fr)
{
...
void ImGui_ImplWGPU_RenderDrawData(ImDrawData* draw_data, WGPURenderPassEncoder pass_encoder)
{
    ...
    if (fr->VertexBuffer == nullptr || fr->VertexBufferSize < draw_data->TotalVtxCount)
    {
        ...
        WGPUBufferDescriptor vb_desc = {nullptr, "Dear ImGui Vertex buffer",
            WGPUBufferUsage_CopyDst | WGPUBufferUsage_Vertex,
            fr->VertexBufferSize * sizeof(ImDrawVert), false};
    ...
    if (fr->IndexBuffer == nullptr || fr->IndexBufferSize < draw_data->TotalIdxCount)
    {
        ...
        WGPUBufferDescriptor ib_desc = {nullptr, "Dear ImGui Index buffer",
            WGPUBufferUsage_CopyDst | WGPUBufferUsage_Index,
            fr->IndexBufferSize * sizeof(ImDrawIdx), false};
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                else if (tex_id) // CARE!
                {
                    ...
                    wgpuRenderPassEncoderSetBindGroup(
                        pass_encoder, 1, image_bind_group, 0, nullptr);
                }
                else
                    continue;
                ...
                wgpuRenderPassEncoderSetScissorRect(pass_encoder, (uint32_t)clip_min.x,
                    (uint32_t)clip_min.y, (uint32_t)(clip_max.x - clip_min.x),
...
static void ImGui_ImplWGPU_CreateFontsTexture()
{
    ...
    // Upload texture to graphics system
    {
        ...
        g_resources.FontTextureView = wgpuTextureCreateView(
            g_resources.FontTexture, &tex_view_desc);
    }
    ...
    // point/nearest sampling)
    {
        ...
        sampler_desc.mipmapFilter = (decltype(sampler_desc.mipmapFilter))1u;
...
static void ImGui_ImplWGPU_CreateUniformBuffer()
{
    WGPUBufferDescriptor ub_desc = {nullptr, "Dear ImGui Uniform buffer",
        WGPUBufferUsage_CopyDst | WGPUBufferUsage_Uniform, sizeof(Uniforms), false};
    ...
    *f = true;
    if (status == WGPUCompilationInfoRequestStatus_Error)
    {
        for (uint32_t m = 0; m < compilationInfo->messageCount; ++m)
        {
            ...
            printf("lineNum: %llu, linePos: %llu, Error: %s", message.lineNum, message.linePos,
                message.message);
        }
    }
}
WGPUShaderModule wgpu_create_shader_module_from_wgsl(WGPUDevice device, const char* source)
{
    ...
    // wgpuShaderModuleGetCompilationInfo(shader_module, wgpu_compilation_info_callback, &ended);
...
bool ImGui_ImplWGPU_CreateDeviceObjects()
{
    ...
    static auto frag_mod = wgpu_create_shader_module_from_wgsl(g_wgpuDevice, wgsl_frag_code);
    static auto vert_mod = wgpu_create_shader_module_from_wgsl(g_wgpuDevice, wgsl_vert_code);

    graphics_pipeline_desc.vertex.module = vert_mod;
    graphics_pipeline_desc.vertex.entryPoint = "main";
    ...
    fragment_state.module = frag_mod;
    ...
    graphics_pipeline_desc.depthStencil = g_depthStencilFormat == WGPUTextureFormat_Undefined
                                              ? nullptr
                                              : &depth_stencil_state;
    ...
    g_resources.ImageBindGroups.SetVoidPtr(
        ImHashData(&g_resources.FontTextureView, sizeof(ImTextureID)), image_bind_group);

    // SafeRelease(frag_mod);
    // SafeRelease(vert_mod);
...
void ImGui_ImplWGPU_InvalidateDeviceObjects()
{
    ...
    ImGuiIO& io = ImGui::GetIO();
    io.Fonts->SetTexID(
        0); // We copied g_pFontTextureView to io.Fonts->TexID so let's clear that as well.
